...
fit1 <- holt(doge_train, h = length(test)) #additive Holt-Winters method
fit2 <- holt(doge_train, seasonal="multiplicative", h = length(test)) #multiplicative Holt-Winters method
fit3 <- holt(doge_train, damped=TRUE, h = length(test)) #additive Holt-Winter method with damped trend 
fit4 <- holt(doge_train, seasonal="multiplicative", damped=TRUE, h = length(test)) #multiplicative Holt-Winter method with damped trend 
